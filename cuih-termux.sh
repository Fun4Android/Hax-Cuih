...
echo ""
sleep 2
python2 CMSmap/cmsmap.py -t http://$fucked/
echo ""
echo -e $blue"
  +-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ +-+-+-+-+
...
echo ""
sleep 2
python2 WPSeku/wpseku.py -t http://$fucked/
echo ""
echo -e $blue"
  +-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ +-+-+-+-+
...
echo ""
sleep 2
python2 Infoga/infoga.py --domain $fucked --source google -v 3
echo ""
echo -e $blue"
  +-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ +-+-+-+-+
...
echo ""
sleep 2
python2 XSSTracer/xsstracer.py $fucked 80
echo ""
echo -e $blue"
  +-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ +-+-+-+-+
